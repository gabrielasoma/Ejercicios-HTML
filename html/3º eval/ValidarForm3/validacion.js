...
function validacion(){
    ...
    var nombre, apellido, correo, edad, telefono, usuario, CorreoValido, NombreValido, ApellidoValido;
...
//controlo que se rellene todos los campos porque son obligatorios
    if(nombre == "" || apellido == "" || correo == "" || edad == "" || telefono == "" || usuario == ""){
